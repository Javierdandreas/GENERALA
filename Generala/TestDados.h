...
void tituloAnimado() {
    ...
    char vtitulo[] = "BIENVENIDO AL GRAFICADOR DE DADOS";
    int vlongitud;
...
int MenuPrincipalGenerala() {
    ...
    locate(35, 9); cout << "      1-MOSTRAR DADOS ALEATORIOS" << endl;
    locate(35, 10); cout << "      2-CARGAR DADOS MANUAL" << endl;
    locate(35, 11); cout << "      3-SALIR" << endl;
    locate(31, 14); cout << "Produced By: Ramiro Alegre y Matias Vietez";
    locate(31, 15); cout << "Editado para ejemplificar el uso de RLUTIL";
    ...
    while (!elegir) {
        if (_kbhit()) {
            ...
            if (tecla == ABAJO && y < 11) locate(x, y++);
            locate(x, y); printf("*");
        }
    }
}
...
void MenuDeDados(int dados[]) {    // dibujalos dados respecto a los valores que se le entreguen en las distintas posiciones
    ...
    for (i = 0; i <5; i++) {
        ...
        /*dado 6*/  case 6:
            if (i == 0) {
                locate(4, 4); printf("%c", 245);
                locate(4, 6); printf("%c", 245);
                locate(8, 4); printf("%c", 245);
                locate(4, 5); printf("%c", 245);
                locate(8, 5); printf("%c", 245);
                locate(8, 6); printf("%c", 245);
            }
            if (i == 1) {
                locate(14, 4); printf("%c", 254);
                locate(14, 6); printf("%c", 254);
